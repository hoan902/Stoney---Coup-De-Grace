...
public class SoundManager : MonoBehaviour
{
    ...
    private void SaveCache()
    {
        ...
        PlayerPrefs.SetInt(GlobalConstants.SOUND, m_soundOn ? 1 : 0);
        PlayerPrefs.Save();
    }

    private void LoadCache()
    {
        m_musicOn = PlayerPrefs.GetInt(GlobalConstants.MUSIC, 1) == 1;
        m_soundOn = PlayerPrefs.GetInt(GlobalConstants.SOUND, 1) == 1;
    }
